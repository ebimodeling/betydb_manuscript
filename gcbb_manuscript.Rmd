...
ppp <- cowplot::plot_grid(plotlist = ppp, nrow = 1)
ppp
ggsave(plot = ppp, 
      filename = 'figures/yield_ma_plots.png', 
      width = 400, height = 100, dpi = 300, units = 'mm')
